...
<html lang="en">
  ...
  <body>
    <div class="container mt-5">
        <form action="{{url('borangdaftar')}}" method="POST">
            @csrf
            <div class="row">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="name"> Nama kaunselor <span class="text-danger"> * </span> </label>
                            ...
                            <div class="form-group">
                                <label for="user_type">  <span class="text-danger"> * </span></label>
                                    <input type="text" name="user_type" class="form-control" value="Kaunselor" />
                            ...
                            <div class="form-group">
                                <label for="confirm_password"> Sahkan kata laluan<span class="text-danger"> * </span></label>
